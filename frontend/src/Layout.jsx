      ...
      <header className="w-full bg-white text-gray-800 py-3 px-6 shadow-lg sticky top-0 z-50 border-b border-gray-100">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <Link to="/" className="font-medium text-gray-600 hover:text-blue-600 transition-colors duration-300">
              Home
            </Link>
            <Link to="/ApplyLoan" className="font-medium text-gray-600 hover:text-blue-600 transition-colors duration-300">
              Apply Loan
            </Link>
            <Link to="/LoanCalculator" className="font-medium text-gray-600 hover:text-blue-600 transition-colors duration-300">
              Loan Calculator
            </Link>
            <Link to="/Status" className="font-medium text-gray-600 hover:text-blue-600 transition-colors duration-300">
              Status
            </Link>
            <Link to="/About" className="font-medium text-gray-600 hover:text-blue-600 transition-colors duration-300">
              About Us
            </Link>
            ...
            <div className="relative ml-4" ref={userMenuRef}>
              <button 
                ...
                className="flex items-center justify-center w-10 h-10 rounded-full bg-blue-50 hover:bg-blue-100 text-blue-600 transition-colors duration-300"
              >
          ...
          {/* Mobile Menu Button */}
          <button 
            className="md:hidden p-2 rounded-md text-gray-600 hover:bg-gray-100 transition-colors duration-300 focus:outline-none"
        ...
        {/* Mobile Menu */}
        {isMobileMenuOpen && (
          <div className="md:hidden mt-3 pt-2 pb-3 space-y-1 bg-white border-t border-gray-100 animate-fadeIn">
            <Link 
              to="/" 
            ...
            <Link 
              to="/profile" 
              className="block px-4 py-2 text-base font-medium text-gray-600 hover:bg-blue-50 hover:text-blue-600 flex items-center"
              onClick={() => setIsMobileMenuOpen(false)}
            >
